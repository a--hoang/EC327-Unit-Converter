    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Input_spin.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View view,
                ...
                if(position < 6)
                {
                    ArrayAdapter<String> dataAdapter_out = new ArrayAdapter<String>(thisContext, android.R.layout.simple_spinner_item,bit_list);
                    Output_spin.setAdapter(dataAdapter_out);
                }
                else if(position > 5)
                {
                    ArrayAdapter<String> dataAdapter_out = new ArrayAdapter<String>(thisContext, android.R.layout.simple_spinner_item,num_list);
                    Output_spin.setAdapter(dataAdapter_out);
                }
